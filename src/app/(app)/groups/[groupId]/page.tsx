    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          {isAdminOrOwner && (
            <Button nativeButton={false} render={<Link href={`/groups/${groupId}/sessions/new`} />}>
              Start New Game
            </Button>
          )}
          <Button nativeButton={false} variant="outline" render={<Link href={`/groups/${groupId}/settings`} />}>
            Settings
          </Button>
        </div>
      </div>
      ...
      <section>
        ...
        {leaderboard && leaderboard.length > 0 ? (
          <LeaderboardTable rows={leaderboard} groupId={groupId} />
        ) : (
          <p className="text-sm text-muted-foreground">
